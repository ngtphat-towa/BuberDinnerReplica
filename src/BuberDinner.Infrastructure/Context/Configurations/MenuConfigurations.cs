        ...
        private static void ConfigureMenuSectionsTable(EntityTypeBuilder<Menu> builder)
        {
            builder.OwnsMany(m => m.Sections, sectionBuilder =>
            {
                ...
                sectionBuilder.OwnsMany(
                    ...
                    itemBuilder =>
                    {
                        ConfigureMenuItemsTable(itemBuilder);
                        itemBuilder.OwnedEntityType.RemoveDiscriminatorValue();
                    });
                sectionBuilder
        ...
        private void ConfigureMenuDinnerIdsTable(EntityTypeBuilder<Menu> builder)
        {
            builder.OwnsMany(m => m.DinnerIds, dinnerBuilder =>
            {
                ...
                dinnerBuilder
                    ...
                    .ValueGeneratedNever();
                dinnerBuilder.OwnedEntityType.RemoveDiscriminatorValue(); 
            });
        ...
        private static void ConfigureMenuReviewIdsTable(EntityTypeBuilder<Menu> builder)
        {
            builder.OwnsMany(m => m.MenuReviewIds, reviewBuilder =>
            {
                ...
                reviewBuilder
                    ...
                    .ValueGeneratedNever();
                reviewBuilder.OwnedEntityType.RemoveDiscriminatorValue(); 
            });
