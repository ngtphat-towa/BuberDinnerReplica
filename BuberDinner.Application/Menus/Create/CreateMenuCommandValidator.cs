...
public class CreateMenuCommandValidator : AbstractValidator<CreateMenuCommand>
{
    ...
    {
        RuleFor(cmd => cmd.HostId).NotEmpty().WithMessage("Host ID is required.");
        RuleFor(cmd => cmd.Name).NotEmpty().WithMessage("Menu name is required.");
        RuleFor(cmd => cmd.Description).NotEmpty().WithMessage("Menu description is required.");
...
public class MenuSectionRequestValidator : AbstractValidator<MenuSectionCommand>
{
    ...
    {
        RuleFor(sec => sec.Name).NotEmpty().WithMessage("Section name is required.");
        RuleFor(sec => sec.Description).NotEmpty().WithMessage("Section description is required.");
